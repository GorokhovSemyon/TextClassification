...
This notebook is devoted to the analysis [BERT](https://habr.com/ru/articles/436878/) and DistilBERT models in binary text classification with advanced Cohen's Cappa and ROC AUC metrics.
